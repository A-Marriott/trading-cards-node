...
describe("Trading card game", () => {
  ...
  describe("First player plays first turn", () => {
    it("should increase mana slot", async () => {
      const {findByText} = render(<App/>);
      playTurn.mockImplementation(() => ({players: { active: {displayedName: "player1", health: 30, manaSlot: 1, activeMana: 0, cardsInHand: [1,1,1]}}}))
